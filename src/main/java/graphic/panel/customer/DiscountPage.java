...
public class DiscountPage extends PageController {
    ...
    @FXML private TableView<CodeTable> table;
    @FXML private TableColumn<CodeTable, Integer> percent;
    @FXML private TableColumn<CodeTable, String> start;
    @FXML private TableColumn<CodeTable, String> finish;
    @FXML private TableColumn<CodeTable, String> code;
    @FXML private TableColumn<CodeTable, Integer> maxUsableTime;
    @FXML private TableColumn<CodeTable, Integer> maxDiscountAmount;
    ...
    public static class CodeTable {
        ...
        private SimpleIntegerProperty maxUsableTime;
        private SimpleIntegerProperty maxDiscountAmount;
