...
public class OutputCommands {
    ...
    public static void enterFinishTime() {
        System.out.println("enter finish time");
    }

    public static void enterMaxUsableTime() {
        System.out.println("enter maximum usable time");
    }

    public static void enterMaxDiscountAmount() {
        System.out.println("enter maximum discount amount");
    }

    public static void enterPercent() {
