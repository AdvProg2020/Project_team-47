...
public class RemoveSubCategoryCommand extends Command {
    public RemoveSubCategoryCommand(Menu menu) {
        super(menu);
        setSignature("remove sub category [category]");
        setRegex("^remove sub category [^\\s]+$");
    }
    ...
    private void sendMessage(String text) {
        ...
        ViewToController.setViewMessage("remove sub category");
