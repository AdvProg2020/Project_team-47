...
import view.menu.allProductsMenu.commands.ShowProductCommand;
...
public class AllProductsMenu extends Menu {
    ...
    protected void setSubMenus() {
        subMenus.add(new FilteringMenu(this, "products"));
        subMenus.add(new SortingMenu(this, "products"));
    ...
    protected void addCommands() {
        ...
        menuCommands.add(new FilteringCommand(this, "products"));
        menuCommands.add(new SortingCommand(this, "products"));
